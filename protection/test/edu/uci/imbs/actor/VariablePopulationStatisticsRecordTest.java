...
public class VariablePopulationStatisticsRecordTest
{
	...
	public void verifyStatisticsRecordPrintsAllFields() throws Exception
	{
		...
		assertEquals("Period=1, Number Bandits=2, Number Peasants=3, Number Bandits After Replication=0, Number Peasants After Replication=0, Average Bandit Payoff=4.0, Average Peasant Payoff=5.0, Bandit-Peasant Payoff Delta=6.0, Peasant Adjustment=-7, Average Protection Proportion=0.8, Median Protection Proportion=0.9, Mode Protection Proportion=0.1, Average Number Peasants To Prey Upon=2.0, Median Number Peasants To Prey Upon=3.0, Mode Number Peasants To Prey Upon=4", record.toString());
